...
const MaintenanceWorkOrderV3 = {
  ...
  init() {
    ...
    if (window.QueryVariant) {
      QueryVariant.mount('maintenance-workorder-v3');
      QueryVariant.restore('maintenance-workorder-v3');
      QueryVariant.bindRecent('maintenance-workorder-v3');
    }
  ...
  search() {
    ...
    if (window.QueryVariant) {
      QueryVariant.saveAuto('maintenance-workorder-v3');
      QueryVariant.recordUsed('maintenance-workorder-v3');
    }
  },
  ...
  reset() {
    ...
    if (window.QueryVariant) QueryVariant.resetSelection('maintenance-workorder-v3');
  },
...
if (window.QueryVariant) {
  QueryVariant.register({
    pageId: 'maintenance-workorder-v3',
    fields: ['wo3AUFNR', 'wo3EQUNR', 'wo3AUART', 'wo3STAT', 'wo3PRIOK'],
    textFields: ['wo3AUFNR', 'wo3EQUNR'],
    labels: { wo3AUFNR: '工单号', wo3EQUNR: '设备编码', wo3AUART: '类型', wo3STAT: '状态', wo3PRIOK: '优先级' },
    onApply: function () { MaintenanceWorkOrderV3.search(); }
  });
}
